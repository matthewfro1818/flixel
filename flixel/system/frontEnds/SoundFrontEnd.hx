...
class SoundFrontEnd
{
	 ...
	 */
	public function playMusic(Volume:Float = 1, Looped:Bool = true):Void
	{
		if (music == null)
		{
			music = new FlxSound();
	 ...
	 */
	public function load(Volume:Float = 1, Looped:Bool = false, AutoDestroy:Bool = false, AutoPlay:Bool = false, ?URL:String, ?OnComplete:Void->Void):FlxSound
	{
